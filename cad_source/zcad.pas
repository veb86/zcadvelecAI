...
uses
 ...
 {$ENDIF}
  ...
  uzeentacdproxy,    {USE AI. Completely generated by the AI agent. Поддержка прокси-объектов ACAD_PROXY_ENTITY }

  uzccommand_explodeblockproxy,  { USE AI. Completely generated by the AI agent. Команда ExplodeBlockProxy — расчленение BlockInsert/ProxyEntity }
