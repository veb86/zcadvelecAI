...
const
  ...
  // Минимальная длина линии, которую можно считать границей таблицы
  MIN_TABLE_LINE_LENGTH = 1.0;

  // Допуск при сравнении координат для группировки совпадающих границ
  COORDINATE_TOLERANCE = 0.01;

  // Допуск для определения горизонтальности/вертикальности линии
  LINE_ORIENTATION_TOLERANCE = 0.5;
