...
procedure VRestoreTable_ShowDialog(aWorkbook: TsWorkbook);

// Сохраняет книгу в XLSX файл с диалогом выбора пути
// Возвращает True при успешном сохранении
function VRestoreTable_SaveAsXLSX(aWorkbook: TsWorkbook): Boolean;
      ...
      IRId:
        case commandmanager.GetLastId of
          ...
          begin
            ...
            VRestoreTable_SaveAsXLSX(aWorkbook);
            Break;
          end;
          ...
          begin
            ...
            VRestoreTable_OpenInSpreadsheet(aWorkbook);
            Break;
          end;
