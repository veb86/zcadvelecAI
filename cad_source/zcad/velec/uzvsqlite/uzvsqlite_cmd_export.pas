...
uses
  ...
  uzvsqlite_types, uzvsqlite_config, uzvsqlite_exporter, uzclog;

// Процедура выполнения команды экспорта
procedure CmdUzvSQLiteExport(
...
begin
  ...
  programlog.LogOutFormatStr(
    'uzvsqlite: Начало выполнения команды экспорта',
    [],
    LM_Info
  );
  ...
  try
    ...
    try
      // Показываем диалог выбора файла SQLite
      accessFile := '';
