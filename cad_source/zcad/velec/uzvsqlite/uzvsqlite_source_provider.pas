...
unit uzvsqlite_source_provider;
...
uses
  ...
  uzeentity, uzsbvarmandef, uzcvariablesutils, uzetypes,
  uzvgetentity, uzvsqlite_types, uzclog;
...
begin
  ...
  programlog.LogOutFormatStr(
    'uzvsqlite: Загружено примитивов: %d',
    [FEntityList.Size],
    LM_Info
  );
end;
...
begin
  ...
  begin
    programlog.LogOutFormatStr(
      'uzvsqlite: Попытка получить свойство из nil-объекта',
      [],
      LM_Info
    );
    Exit;
